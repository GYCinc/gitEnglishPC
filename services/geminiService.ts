import { GoogleGenerativeAI, SchemaType, Modality } from "@google/generative-ai";
      ...
      return {
        ...
        schema: {
          ...
          items: {
            ...
            properties: {
              question: { type: SchemaType.STRING, description: "The sentence with a '[BLANK]' for the missing word." },
              answer: { type: SchemaType.STRING, description: "The word that fits in the blank." },
              wordBank: { type: SchemaType.ARRAY, items: { type: SchemaType.STRING }, description: "An array with the correct answer and 2-3 distractors." },
            },
      ...
      return {
        ...
        schema: {
          ...
          items: {
            type: SchemaType.OBJECT,
            properties: {
              question: { type: SchemaType.STRING, description: "The sentence with a '[BLANK]' where a collocate is missing." },
              answer: { type: SchemaType.STRING, description: "The word that completes the collocation." },
              wordBank: { type: SchemaType.ARRAY, items: { type: SchemaType.STRING }, description: "An array with the correct answer and 2-3 distractors." },
              collocation: { type: SchemaType.STRING, description: "The full collocation, e.g., 'heavy rain'." }
            },
      ...
      return {
        ...
        schema: {
          ...
          items: {
            type: SchemaType.OBJECT,
            properties: {
              question: { type: SchemaType.STRING, description: "The sentence with a '[BLANK]' where a particle is missing." },
              answer: { type: SchemaType.STRING, description: "The particle that completes the phrasal verb." },
              wordBank: { type: SchemaType.ARRAY, items: { type: SchemaType.STRING }, description: "An array with the correct particle and 2-3 distractors." },
              phrasalVerb: { type: SchemaType.STRING, description: "The full phrasal verb, e.g., 'give up'." }
            },
      ...
      return {
        ...
        schema: {
          ...
          items: {
            type: SchemaType.OBJECT,
            properties: {
              question: { type: SchemaType.STRING, description: "The sentence with a '[BLANK]' for the missing word form." },
              rootWord: { type: SchemaType.STRING, description: "The base word to be transformed." },
              answer: { type: SchemaType.STRING, description: "The correctly formed word that fits in the blank." },
            },
      ...
      return {
        ...
        schema: {
          ...
          items: {
            type: SchemaType.OBJECT,
            properties: {
              question: { type: SchemaType.STRING, description: "The question or sentence to complete." },
              options: { type: SchemaType.ARRAY, items: { type: SchemaType.STRING }, description: "An array of 4 choices (3 incorrect, 1 correct)." },
      ...
      return {
        ...
        schema: {
          ...
          items: {
            type: SchemaType.OBJECT,
            properties: {
              scrambledWords: { type: SchemaType.ARRAY, items: { type: SchemaType.STRING }, description: "An array of words for a sentence in a random order." },
              correct: { type: SchemaType.STRING, description: "The correctly formed sentence." },
            },
      ...
      return {
        ...
        schema: {
          ...
          items: {
            type: SchemaType.OBJECT,
            properties: {
              paragraph: { type: SchemaType.STRING, description: "The paragraph with multiple '[BLANK]' placeholders." },
              answers: { type: SchemaType.ARRAY, items: { type: SchemaType.STRING }, description: "An ordered list of answers for the blanks." },
              wordBank: { type: SchemaType.ARRAY, items: { type: SchemaType.STRING }, description: "An array of all correct answers and some distractors, shuffled." },
            },
      ...
      return {
        ...
        schema: {
          ...
          items: {
            type: SchemaType.OBJECT,
            properties: {
              prompts: { type: SchemaType.ARRAY, items: { type: SchemaType.STRING }, description: "A list of prompts (e.g., words, questions, phrases)." },
              answers: { type: SchemaType.ARRAY, items: { type: SchemaType.STRING }, description: "A corresponding list of answers (e.g., definitions, responses, social functions)." },
            },
      ...
      return {
        ...
        schema: {
          ...
          items: {
            type: SchemaType.OBJECT,
            properties: {
              incorrectSentence: { type: SchemaType.STRING, description: "A sentence with one grammatical error." },
              correctSentence: { type: SchemaType.STRING, description: "The corrected version of the sentence." },
            },
      ...
      return {
        ...
        schema: {
          ...
          items: {
            type: SchemaType.OBJECT,
            properties: {
              dialogue: { type: SchemaType.STRING, description: "A dialogue with '[BLANK]' placeholders." },
              answers: { type: SchemaType.ARRAY, items: { type: SchemaType.STRING }, description: "An ordered list of answers for the blanks." },
              wordBank: { type: SchemaType.ARRAY, items: { type: SchemaType.STRING }, description: "An array of all correct answers and some distractors, shuffled." },
            },
      ...
      return {
        ...
        schema: {
          ...
          items: {
            type: SchemaType.OBJECT,
            properties: {
              title: { type: SchemaType.STRING, description: "The title of the story." },
              storyParts: { type: SchemaType.ARRAY, items: { type: SchemaType.STRING }, description: "An array of strings, where each string is a part of the story in correct chronological order." },
            },
      ...
      return {
        ...
        schema: {
          ...
          items: {
            type: SchemaType.OBJECT,
            properties: {
              storyStart: { type: SchemaType.STRING, description: "The beginning of a story." },
              options: { type: SchemaType.ARRAY, items: { type: SchemaType.STRING }, description: "An array of 3 choices for what happens next." },
              correctAnswer: { type: SchemaType.STRING, description: "The most logical continuation of the story from the options." },
            },
      ...
      return {
        ...
        schema: {
          ...
          items: {
            type: SchemaType.OBJECT,
            properties: {
              sentences: { type: SchemaType.ARRAY, items: { type: SchemaType.STRING }, description: "An array of 3-4 example sentences demonstrating a grammar rule." },
              question: { type: SchemaType.STRING, description: "A question asking to identify the rule." },
              options: { type: SchemaType.ARRAY, items: { type: SchemaType.STRING }, description: "An array of 3 possible rules (1 correct, 2 incorrect)." },
              correctAnswer: { type: SchemaType.STRING, description: "The correct rule description." },
            },
      ...
      return {
        ...
        schema: {
          ...
          items: {
            type: SchemaType.OBJECT,
            properties: {
              sentenceA: { type: SchemaType.STRING },
              sentenceB: { type: SchemaType.STRING },
              question: { type: SchemaType.STRING, description: "A question about the meaning change." },
              options: { type: SchemaType.ARRAY, items: { type: SchemaType.STRING }, description: "An array of 3 explanations for the difference." },
              correctAnswer: { type: SchemaType.STRING, description: "The correct explanation." },
            },
        ...
        schema: {
          ...
          items: {
            ...
            properties: {
              ...
              dilemma: { type: SchemaType.STRING, description: "The text of the moral dilemma." },
            },
      ...
      return {
        ...
        schema: {
          ...
          items: {
            ...
            properties: {
              title: { type: SchemaType.STRING },
              text: { type: SchemaType.STRING, description: "The full text for the reading exercise." },
              question: { type: SchemaType.STRING, description: "A multiple-choice question about the main idea." },
      ...
      return {
        ...
        schema: {
          ...
          items: {
            ...
            properties: {
              title: { type: SchemaType.STRING },
              text: { type: SchemaType.STRING, description: "The text containing specific details." },
              questions: {
                type: SchemaType.ARRAY,
                items: {
                  type: SchemaType.OBJECT,
      ...
      return {
        ...
        schema: {
          ...
          items: {
            ...
            properties: {
              title: { type: SchemaType.STRING },
              scenario: { type: SchemaType.STRING, description: "The context for the writing task." },
              task: { type: SchemaType.STRING, description: "The specific writing instructions." },
            },
        ...
        schema: {
          type: SchemaType.ARRAY, items: {
            type: SchemaType.OBJECT, properties: {
              title: { type: SchemaType.STRING },
              text: { type: SchemaType.STRING, description: "A short, grammatically dense text for reconstruction." },
            }, required: ["title", "text"],
          }
        },
      };
    case ExerciseType.CollocationOddOneOut:
      return {
        ...
        schema: {
          type: SchemaType.ARRAY, items: {
            type: SchemaType.OBJECT, properties: {
              keyword: { type: SchemaType.STRING, description: "The central word for the collocation." },
              options: { type: SchemaType.ARRAY, items: { type: SchemaType.STRING }, description: "4 words: 3 that collocate, 1 that does not." },
              correctAnswer: { type: SchemaType.STRING, description: "The word from the options that does NOT collocate with the keyword." },
      ...
      return {
        ...
        schema: {
          type: SchemaType.ARRAY, items: {
            type: SchemaType.OBJECT, properties: {
              title: { type: SchemaType.STRING },
              text: { type: SchemaType.STRING, description: "A text rich with specific details." },
              formFields: { type: SchemaType.ARRAY, items: { type: SchemaType.STRING }, description: "An array of labels for the information to be extracted." },
      ...
      return {
        ...
        schema: {
          type: SchemaType.ARRAY, items: {
            type: SchemaType.OBJECT, properties: {
              title: { type: SchemaType.STRING },
              audioText: { type: SchemaType.STRING, description: "The script to be read aloud for the listening task." },
              questions: {
                type: SchemaType.ARRAY, items: {
                  type: SchemaType.OBJECT, properties: {
                    question: { type: SchemaType.STRING },
      ...
      return {
        ...
        schema: {
          type: SchemaType.ARRAY, items: {
            type: SchemaType.OBJECT, properties: {
              title: { type: SchemaType.STRING },
              scenario: { type: SchemaType.STRING, description: "The text of the problem-solving scenario." },
      ...
      return {
        ...
        schema: {
          type: SchemaType.ARRAY, items: {
            type: SchemaType.OBJECT, properties: {
              title: { type: SchemaType.STRING },
              character: { type: SchemaType.STRING, description: "The character the learner plays." },
              situation: { type: SchemaType.STRING, description: "The context of the role-play." },
              task: { type: SchemaType.STRING, description: "The specific instruction for what to write." },
      ...
      return {
        ...
        schema: {
          type: SchemaType.ARRAY, items: {
            type: SchemaType.OBJECT, properties: {
              title: { type: SchemaType.STRING },
              prompts: { type: SchemaType.ARRAY, items: { type: SchemaType.STRING }, description: "3-4 keywords or phrases to include in a story." },
              task: { type: SchemaType.STRING, description: "The specific instruction to write a story." },
      ...
      return {
        ...
        schema: {
          type: SchemaType.ARRAY, items: {
            type: SchemaType.OBJECT, properties: {
              title: { type: SchemaType.STRING },
              statement: { type: SchemaType.STRING, description: "A debatable statement." },
              task: { type: SchemaType.STRING, description: "Instruction to agree/disagree and justify." },
      ...
      return {
        ...
        schema: {
          type: SchemaType.ARRAY, items: {
            type: SchemaType.OBJECT, properties: {
              title: { type: SchemaType.STRING },
              promptA: { type: SchemaType.STRING, description: "Rich description of the first scene." },
              promptB: { type: SchemaType.STRING, description: "Rich description of the second, related scene." },
              task: { type: SchemaType.STRING, description: "Instruction to compare and contrast the scenes." },
    ...
    case ExerciseType.PolitenessScenarios:
      return {
        ...
        schema: {
          type: SchemaType.ARRAY, items: {
            type: SchemaType.OBJECT, properties: {
              scenario: { type: SchemaType.STRING, description: "The social context." },
              question: { type: SchemaType.STRING, description: "The question asking for the best response." },
              options: { type: SchemaType.ARRAY, items: { type: SchemaType.STRING } },
              correctAnswer: { type: SchemaType.STRING },
    ...
    case ExerciseType.InferringMeaning:
      return {
        ...
        schema: {
          type: SchemaType.ARRAY, items: {
            type: SchemaType.OBJECT, properties: {
              dialogue: { type: SchemaType.STRING, description: "A short dialogue with an implied meaning." },
              question: { type: SchemaType.STRING, description: "A question asking for the implied meaning." },
              options: { type: SchemaType.ARRAY, items: { type: SchemaType.STRING } },
              correctAnswer: { type: SchemaType.STRING },
    ...
    if (exerciseType === ExerciseType.PicturePrompt) {
      ...
      for (let i = 0; i < amount; i++) {
        ...
        generatedExercises.push({
            ...
            imageUrl: "https://placehold.co/600x400?text=AI+Image+Generation+Unavailable",
            prompt: imagePrompt
        });
      }
